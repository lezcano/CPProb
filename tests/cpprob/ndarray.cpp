...
TEST(ndarray, trivial_constructor)
{
    ...
    EXPECT_EQ(test_double.shape(), std::vector<int>{});

    NDArray<int> arr_int{};
    EXPECT_EQ(arr_int.values(), std::vector<int>{});
    EXPECT_EQ(arr_int.shape(), std::vector<int>{});
}
...
TEST(ndarray, constructor_from_object_same_type)
{
    ...
    EXPECT_EQ(test_double.shape(), std::vector<int>{1});

    NDArray<int> arr_int{3};
    EXPECT_EQ(arr_int.values(), std::vector<int>{3});
    EXPECT_EQ(arr_int.shape(), std::vector<int>{1});
}
...
TEST(ndarray, constructor_from_vector_same_type)
{
    ...
    NDArray<double> test_double{vec_double};
    EXPECT_EQ(test_double.values(), vec_double);
    EXPECT_EQ(test_double.shape(), std::vector<int>{static_cast<int>(vec_double.size())});

    std::vector<int> vec_int{2, 3, 8, -2, 0};
    NDArray<int> arr_int{vec_int};
    EXPECT_EQ(arr_int.values(), vec_int);
    EXPECT_EQ(arr_int.shape(), std::vector<int>{static_cast<int>(vec_int.size())});
}
...
TEST(ndarray, constructor_from_matrix_compatible_type)
{
    ...
    NDArray<double> arr_int{mat_float};
...
TEST(ndarray, constructor_from_matrix_compatible_type_padding)
{
    std::vector<std::vector<int>> mat_int{{2, 3},
                                          {5, 1, 3, 6}};
    NDArray<double> test_double{mat_int};
    ...
    EXPECT_EQ(arr_int.values(), std::vector<double>({2, 3, 8, -2, 0,
                                                    ...
                                                    1, 2, 5, 1,  2,
                                                    1, 2, 0, 0,  0}));
    EXPECT_EQ(arr_int.shape(), std::vector<int>({4, 5}));
}
...
TEST(ndarray, constructor_from_four_tensor)
{
    ...
    NDArray<double> test_tensor{four_tensor};
    ...
    EXPECT_EQ(test_tensor.shape(), std::vector<int>({2, 3, 4, 4}));
}
