...
public:
    ...
    // construct/copy/destruct
    explicit min_max_continuous_distribution(RealType min = 0.0, RealType max = 1.0, RealType mode = 1.0, RealType k = 1.0)
    ...
    // public member functions
    template<typename URNG> RealType operator()(URNG & rng) const
    {
